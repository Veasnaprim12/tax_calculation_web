...
urlpatterns = [
    ...
    path("about/advertising-board/", views.about_advertising_board_tax, name="about_advertising_board_tax"),
	...
	path("advertising-board/", views.advertising_board_tax, name="advertising_board_tax"),
